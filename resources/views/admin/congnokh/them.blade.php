                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <form action="admin/congnokh/them" method="POST">
	                                ...
	                                <div class="form-group">
                                        ...
                                        <input class="form-control" name="sotienthu" placeholder="Nhập tên người quản lý tổ chức" >
	                                </div>

                                    <div class="form-group">
                                        <label>Ngày thu</label>
                                        <input class="form-control" name="ngaythu" placeholder="Nhập tên người quản lý tổ chức" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Ghi chú</label>
                                        <input class="form-control" name="ghichu" placeholder="Nhập tên người quản lý tổ chức" >
                                    </div>
